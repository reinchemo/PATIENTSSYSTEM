            ...
            <form id="registration-frm" action="" method="post">
              ...
              <div class="row">
                    <div class="form-group col-md-10">
                      ...
                      <small class="mx-2">Email</small>  <input type="email" name="email" id="email" placeholder="" required class="form-control form-control-sm form-control-border">
              ...
              <div class="row">
                    <div class="form-group col-md-10">
                      ...
                      <small class="mx-2">Confirm Password</small><input type="password" name="cpass" id="cpass" required class="form-control form-control-sm form-control-border">
